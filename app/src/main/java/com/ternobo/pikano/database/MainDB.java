...
public class MainDB<RecentlyNullable> implements Serializable {

    private User currentUser;
    private boolean isFullSignup = false;
     ...
     * @since 1.8
     */
    public void replaceAll(@NonNull BiFunction<? super String, ? super String, ? extends String> function) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            files.replaceAll(function);
        }
    }
    ...
    public String putIfAbsent(@NonNull String key, @NonNull String value) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            return files.putIfAbsent(key, value);
        }
        return null;
    }
     ...
     * @since 1.8
     */
    public boolean replace(String key, @Nullable String oldValue, String newValue) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
    ...
    public String replace(@NonNull String key, @NonNull String value) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            return files.replace(key, value);
        }
        return null;
    }
    ...
    public boolean isFullSignup() {
        return isFullSignup;
    }

    public void setFullSignup(boolean fullSignup) {
        isFullSignup = fullSignup;
    }
}
