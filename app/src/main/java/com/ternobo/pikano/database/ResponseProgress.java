...
public abstract class ResponseProgress {

    public abstract void onProgressUpdate(long numBytes, long totalBytes, float percent, float speed);

    public abstract void onUIProgressStart(long totalBytes);

    public abstract void onUIProgressFinished();
